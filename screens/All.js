...
import { Button, View, StyleSheet, RefreshControl, TouchableWithoutFeedback, Animated, ImageBackground ,Linking} from 'react-native';
import { Text, Card, Divider, Icon } from 'react-native-elements';
// import Icon from 'react-native-vector-icons';
import backgrondImg from '../assets/Background.jpg'
import { NativeBaseProvider, FlatList, ScrollView, Image, Spinner } from 'native-base';
import { services } from '../services/services';
import moment from 'moment'
import Modal from "react-native-modal";
import WeatherCard from './WeatherCard';
import { flex, justifyContent, padding, paddingTop, width } from 'styled-system';
...
const openShareDialogAsync = async (mediaProps, index) => {
    ...
    const downloadPath = `${FileSystem.cacheDirectory}image-all${index}${fileDetails.extension}`;
...
class NewsItem extends React.Component {
    ...
    //     await Sharing.shareAsync(this.props.item.urlToImage);
    //   }; 
    render() {
